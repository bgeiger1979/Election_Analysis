...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if winning_county not in county_options:
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_vote_percentage = float(county_vote_count) / float(county_votes) * 100
        county_results = (
            f"{county_name}: {county_vote_percentage:.1%}% ({county_vote_count:,})\n")
